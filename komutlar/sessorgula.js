...
let embed = new Discord.MessageEmbed().setColor("010000").setFooter("Allah").setTimestamp().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true}))
...
<a:789225050292617236:824626243503915019>  ${üye} isimli kullanıcı şu anda \`${üye.voice.channel.name}\` adlı sesli kanala bağlı! 
